...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://stcautotrade.id/og?t=Cara%20Withdraw%20Stockity%3A%20Panduan%20Tarik%20Dana%20ke%20Rekening%202026&l=id",
        width: 1200,
        height: 630,
...
const articleSchema = {
  ...
  image: "https://stcautotrade.id/og?t=Cara%20Withdraw%20Stockity%3A%20Panduan%20Tarik%20Dana%20ke%20Rekening%202026&l=id",
  mainEntityOfPage: {
    "@type": "WebPage",
                ...
                {[
                  ...
                  <div key={m.title} className="bg-white border border-[rgba(26,22,18,0.08)] rounded-xl p-5">
                    ...
                    <div className="bg-[#f6f4ef] rounded-lg px-3.5 py-2.5 border border-[rgba(26,22,18,0.06)]">
                      <p className="text-[11px] text-[#1a1612]/65 leading-relaxed">{m.note}</p>
                    </div>
                  </div>
                ))}
              </div>
