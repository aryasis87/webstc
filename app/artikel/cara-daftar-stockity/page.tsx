...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://stcautotrade.id/og?t=Cara%20Daftar%20Stockity%3A%20Panduan%20Registrasi%20Akun%20%26%20Mulai%20Trading%202026&l=id",
        width: 1200,
        height: 630,
...
const articleSchema = {
  ...
  image: "https://stcautotrade.id/og?t=Cara%20Daftar%20Stockity%3A%20Panduan%20Registrasi%20Akun%20%26%20Mulai%20Trading%202026&l=id",
  mainEntityOfPage: {
    "@type": "WebPage",
          ...
          <div className="mt-14 pt-10 border-t border-[rgba(26,22,18,0.08)]">
            ...
            <div className="grid sm:grid-cols-3 gap-3">
              {[
                ...
                { href: "/artikel/cara-verifikasi-akun-stockity", title: "Cara Verifikasi Akun Stockity", desc: "Selesaikan KYC sedini mungkin agar withdraw lancar" },
              ].map((l) => (
